package com.hlbd.electric.feature.launcher.data.realtime.busbar.data;
...
public class BusBarData implements IData {

  private static final String TAG = "BusBarData";

  public transient int resId = R.drawable.ic_env_temp;

  public transient String title = "母排温度(℃)";
  ...
  public static class DataShape {
    ...
    public static class FieldDefinitions {
      ...
      @SerializedName(value = "TempBusbar")
      public Content desc;
