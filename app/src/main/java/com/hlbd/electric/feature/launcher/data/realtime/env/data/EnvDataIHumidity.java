...
public class EnvDataIHumidity implements IData {

  private static final String TAG = "EnvDataIHumidity";

  public transient int resId = R.drawable.ic_env_humidity;

  public transient String title = "环境湿度(%)";
  ...
  public static class DataShape {
    ...
    public static class FieldDefinitions {
      ...
      @SerializedName(value = "HumidityAmbient")
      public Content desc;
